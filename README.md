...
| Version | Changes                                                                                                                                                                                                                                                                            |
|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.2.1   | `applicationId` and `namespace` refactored to `io.github.ricardogs98.doubletaplock` for Play Store publication (open-source naming convention). No behavior change.                                                                                                                |
